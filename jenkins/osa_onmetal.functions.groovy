...
def parse_results() {
    ...
    elastic-upgrade -u output/output.txt -d output/during_output.txt -p subunit/persistent_create -o subunit/persistent_create2 -b subunit/before_upgrade -a subunit/after_upgrade
    """
}
